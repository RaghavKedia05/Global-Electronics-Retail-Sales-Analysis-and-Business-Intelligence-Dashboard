...
Set `Order Date`, `Delivery Date`, and `Last_Purchase_Date` to the Date data type. Set revenue, profit, and cost fields to Decimal Number.
...
- Cards: Total Revenue, Total Profit, Total Orders, Total Customers, and Profit Margin %.
...
- Table: Product Name, Total Revenue, and Total Profit; apply a Top 10 revenue filter.
- Table: Name, Total Revenue, and Total Profit; apply a Top 10 revenue filter.
- Slicers: Year, Country_Customer, Category, and StoreKey.

## Page 2 - Store Performance

- Bar chart: StoreKey and Total Revenue.
- Bar chart: StoreKey and Total Profit.
- Table: Store Rank, StoreKey, Country_Store, State_Store, Total Revenue, Total Profit, and Total Orders.
...
- Table: Name, Monetary, Profit, Frequency, Recency, and Customer Segment; apply a Top 20 Monetary filter.
